...
//22 sep 2014 4:35 S.S. Mr Donald Salvador del Mundo, se agrego func
...
//CONSULTANDO LOS DATOS DE LA FACTURA **********************************************************************
	...
	$lcFilePdfOutPut=__DIR__."/".$lcFilePdf;
	//$lcFilePdf2Send="factura".$idfactura.".pdf";
	$pdf->Output($lcFilePdfOutPut, 'F');
	sendFactura($lcFilePdf,$email2Send,$nombre2Send); 
	echo "  ".$lcFilePdf." enviada  a: ".$email2Send." ".$nombre2Send;
