<?php 
/*
Genera la factura en pdf usando la libreria tcpdf:
1)Se extiende la clase tcpdf agregando el codigo para :
	1.a)el footer 
	1.b)el header 
	1.c)writeTotalizar
...
if (isset($_GET['idfact'])){
	...
	// Extender la clase para incluir el footer y el header 
	class YPDF extends TCPDF {
    var $fact;
...
//Instanciando la clase extendida ypdf ***************************************************************
	$pdf = new YPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
	//establecemos el numero de factura 
	$pdf->fact=$idfactura;
	
	// seteando el documento
	...
	if( $rows > 0 ){
		...
		//sin lineas en la factura		
	}

//fin Instanciando la clase extendida ypdf ***************************************************************
